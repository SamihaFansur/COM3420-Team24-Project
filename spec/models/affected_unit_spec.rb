...
RSpec.describe AffectedUnit, type: :model do
  ...
  describe "#date_from" do
    it "return affected unit date_from" do
      affected_unit = described_class.new(date_from: 2022-03-21)
      expect(affected_unit.date_from).to eq(2022-03-21)
    end
  end

  describe "#date_to" do
    it "return affected unit date_to" do
      affected_unit = described_class.new(date_to: 2022-03-21)
      expect(affected_unit.date_to).to eq(2022-03-21)
    end
  end
