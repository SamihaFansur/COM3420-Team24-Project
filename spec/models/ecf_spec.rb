...
RSpec.describe Ecf, type: :model do
  ...
  describe '#end_of_circumstances' do
    it 'return ecf end_of_circumstances' do
      ecf = described_class.new(end_of_circumstances: 2022 - 0o3 - 21)
      expect(ecf.end_of_circumstances).to eq(2022 - 0o3 - 21)
    end
  end
  ...
  describe '#start_of_circumstances' do
    it 'return ecf start_of_circumstances' do
      ecf = described_class.new(start_of_circumstances: 2022 - 0o3 - 21)
      expect(ecf.start_of_circumstances).to eq(2022 - 0o3 - 21)
    end
  end
